<title>Simple Online Attendance System - Mohtadin khan</title><style type="text/css">
<!--
.style1 {
      ...
      <tr>
        ...
        <table width="180px" align="left" style="">
          ...
          <table width="400" border="2" align="left" bordercolor="#9966FF" bgcolor="#C7B6B1" style="margin-left:20px;">
            ...
            <tr bgcolor="#999966">
              <td width="114"><span class="style7">Enrolment ID</span></td>
            ...
            <?php
				...
				while($rec = mysqli_fetch_array($result))
				{
					$s = $s + 1;
					echo ' <tr>
							  <td width="114">'.$rec["enrolment_id"].'</td>
