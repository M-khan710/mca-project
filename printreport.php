<title>Online Attendance - Mohtain khan</title>
<style type="text/css">
<!--
.style1 {
...
<table width="800" border="1" align="center">
      ...
      <tr>
		...
		if(isset($_POST["btnsubmit"]))
		{
			include "z_db.php";
			extract($_POST);
			$query = "select * from `member` where enrolment_id = ".$eno." limit 1";
			...
			while($rec = mysqli_fetch_array($result))
			{
				...
				echo '</tr>
				<tr>
				  <td width="222"><span class="style6">'.$rec["enrolment_id"].'</span></td>
